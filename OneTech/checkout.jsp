	...
	<div class="contact_info">
		<div class="container">
			<div class="row">
				...
				<div class="contact_form_title">Continue with old Address</div>
					<div class="contact_info_container d-flex flex-lg-row flex-column justify-content-between align-items-between">
						...
						<div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
							...
							<div class="contact_info_content">
								<a href="#"><button class="btn btn-outline-primary">Continue</button></a> 
							</div>
						</div>
			...
			<div class="row">
				<div class="col-lg-10 offset-lg-1">
					<div class="contact_form_container">
						<div class="contact_form_title">New Address</div>
                         ...
                         <form class="needs-validation" novalidate>
								  <div class="form-row">
								    ...
								    <div class="col-md-4 mb-3">
								      ...
								      <input type="text" class="form-control" id="validationCustom02" placeholder="User Name"  required>
								      <div class="valid-feedback">
								        Looks good!
								      </div>
								    </div>
								  ...
								  <button class="btn btn-block btn-outline-primary" type="submit">Continue to checkout</button>
								</form>
